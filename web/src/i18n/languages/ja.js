...
lang.pages.guides = {
    schedules: {
        info: "ツアーでの担当ガイドのスケジュール調整のため、参加できるか・できない、若しくは調整すれば可能かの入力をお願いいたします。",
...
これらについては登録ができません。\n\
\n\
TEL、住所(市区町村)、住所(それ以降)、登録年（任意）、メモについては未記入でも構いません。\n\
...
・入力に誤りがあった場合はツアーをキャンセル（中止）し、作成しなおしてください。\n\
※その他の項目に関しては、登録後に変更が可能です。\n\
※ツアー一覧は初期状態で、今日より一ヵ月前以降のツアーを最大100件表示します。それ以外の期間を表示したい場合は、詳細検索を使用してください。\n\
    ",
    subtitle_tour_state: "ツアー状態について",
    tour_state_info: "\
担当ガイド未決定\n\
・ツアー作成直後の状態です。\n\
・ガイドが予定を入力・変更することができます。\n\
\n\
未実施（担当者決定済み）\n\
・担当者が決定した状態です。\n\
・ガイドの予定入力・変更を締め切っています。\n\
・手動で「実施済み」にしない限り、この状態から変化しません。\n\
\n\
実施済み\n\
・ツアーが実施されたことを表す状態です。\n\
・未来の日付であっても既に開催された扱いとなり、ガイドの実績として表示されます。\n\
\n\
中止\n\
・ツアーが中止されたことを表します。\n\
・ツアー情報を変更する全ての操作をすることが出来なくなります。\n\
    ",
    subtitle_guide_achievement: "ガイドの実績について",
    guide_achievement_info: "\n\
実績は、「ガイド詳細情報画面」または「担当ガイドの選択画面」で確認することができます。\n\
\n\
担当割り当て済みのツアー一覧\n\
・担当が割り当てられているツアーのうち、今日以降の「未実施（担当者決定済み）」のツアーの一覧です。\n\
\n\
過去に担当したツアー一覧（最大100件）\n\
・担当が割り当てられているツアーのうち、\"中止を含む\" 今日以前に担当が割り当てられていたツアーと「実施済み」状態のツアーの一覧です。\n\
\n\
最後に担当したツアー\n\
・「実施済み」状態の担当が割り当てられていたツアーの中で、最も日付が新しいツアーが表示されます。\n\
    ",
};
